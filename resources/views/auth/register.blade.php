                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users') }}">
                            ...
                            <div class="row mb-3">
                                <label for="park_name"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Nombre del parque') }}</label>

                                <div class="col-md-6">
                                    <input id="park_name" type="text"
                                        class="form-control @error('park_name') is-invalid @enderror" name="park_name"
                                        value="{{ old('park_name') }}" autocomplete="park_name">
